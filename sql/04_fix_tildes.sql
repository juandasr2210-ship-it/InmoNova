...
UPDATE propiedad SET titulo='Local comercial centro Girón', descripcion='Local esquinero de alto tráfico peatonal, ideal para restaurante o retail.' WHERE matricula_inmobiliaria='MI-DEMO-003';
